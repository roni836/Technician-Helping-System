...
@section('content')
    <div class="bg-teal-100 font-sans antialiased flex flex-col  items-center h-screen p-4 mt-10">

        {{-- {{dd($question)}} --}}
        <span class="text-xl text-start text-teal-700 font-medium mb-4">
            Brand Name: {{ $question->brand ?? 'Not Available' }}
        </span>
        <span class="text-xl text-start text-teal-700 font-medium mb-4">
            Problem: {{ $question->brand ?? 'Not Available' }}
        </span>
